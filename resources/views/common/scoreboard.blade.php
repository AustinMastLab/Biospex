<!-- Modal -->
<div class="modal fade" id="scoreboard-modal" tabindex="-1" role="dialog" aria-labelledby="scoreboardModalTitle">
    <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <div class="empty-icon"><i class="fa fa-fw"></i></div>
                <div><h2 id="scoreboardModalTitle" class="color-action">SCOREBOARD</h2></div>
